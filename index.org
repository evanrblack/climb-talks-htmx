...
* hx-get
#+REVEAL_HTML: <video src="videos/hx-get.mp4" autoplay loop mute style="border: 2px solid black">
...
* hx-target
#+REVEAL_HTML: <video src="videos/hx-target.mp4" autoplay loop mute style="border: 2px solid black">
...
* hx-trigger
#+REVEAL_HTML: <video src="videos/hx-trigger.mp4" autoplay loop mute style="border: 2px solid black">
...
* hx-swap
#+REVEAL_HTML: <video src="videos/hx-swap.mp4" autoplay loop mute style="border: 2px solid black">
...
* hx-select
#+REVEAL_HTML: <video src="videos/hx-select.mp4" autoplay loop mute style="border: 2px solid black">

* Todos
#+REVEAL_HTML: <video src="videos/todos.mp4" autoplay loop mute style="border: 2px solid black; height: 400px">
...
- [[https://github.com/evanrblack/climb-talks-htmx][github.com/evanrblack/climb-talks-htmx]]
